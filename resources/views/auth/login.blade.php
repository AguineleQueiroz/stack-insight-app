<x-guest-layout>
    ...
    <div class="text-sm py-5">
        ...
        <a href="{{ route('register') }}" class="font-semibold text-blue-700 hover:text-blue-700 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
    </div>
</x-guest-layout>
